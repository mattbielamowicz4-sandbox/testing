...
- **Notifications**: Click **Enable Notifications** to request permission (only on click). If allowed, you'll get `Time!` notification with `Your timer finished.` when the timer completes.
